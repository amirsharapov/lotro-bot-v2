...
class ImageDetectionBotService:
    ...
    def detect_yellow_nameplates(self, contour_canvas=None, collect_data=False):
        ...
        if collect_data:
            self.image_processing_bot.find_and_draw_contours(
                ...
                contour_min_area,
                contour_max_area,
                collect_data='yellow_nameplate_'
            )
        else:
            self.image_processing_bot.find_and_draw_contours(
                eroded,
    ...
    def detect_mini_map_character_marker(self, contour_canvas=None, economic=True):
        ...
        # GET IMAGE OFFSET
        x, y, _, _ = self.mini_map_cropped_rect
        offset = (x, y)
